...
const Footer = () => {
    ...
    return (
		...
		<span className=" text-md bottom-3 dark:text-coolGray-400 relative xs3:right-0 xs3:mt-0 xs3:mb-0 mb-2 mt-7 right-3">© Copyright 2022. All Rights Reserved.</span>
	</div>
            </ul>
        </div>
    </footer>
