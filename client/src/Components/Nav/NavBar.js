      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-white rounded-md p-4 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <Popover className="relative">
              {({ open }) => (
                <>
                  ...
                  >
                    <Popover.Panel className="absolute z-10 hover:cursor-pointer left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
